...
import com.myautocompany.simuladorcoches.modelos.coches.*;
...
public class GestorCoches {
    ...
    public static void main(String[] args) {
        ...
        c1.setMotor(new Electrico(1, 200));
        c1.arrancar();
        ICoche c2 = new Familiar("Renault", "Familiar", 130, 5);
        c2.setMotor(new Combustion(2, 200));
        c2.arrancar();
        ICoche c3 = new SUV("Seat", "SUV", 100, 1);
        c3.setMotor(new Combustion(2, 120));
        c3.arrancar();
